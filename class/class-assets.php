...
class Assets {
	...
	public function enqueue_styles() {
		...
		wp_register_style( 'amply-comments', get_theme_file_uri( '/css/comments.css' ), array(), AMPLY_THEME_VERSION );
		wp_register_style( 'amply-content', get_theme_file_uri( '/css/content.css' ), array(), AMPLY_THEME_VERSION );
		wp_register_style( 'amply-sidebar', get_theme_file_uri( '/css/sidebar.css' ), array(), AMPLY_THEME_VERSION );
		wp_register_style( 'amply-widgets', get_theme_file_uri( '/css/widgets.css' ), array(), AMPLY_THEME_VERSION );
		wp_register_style( 'amply-front-page', get_theme_file_uri( '/css/front-page.css' ), array(), AMPLY_THEME_VERSION );
	}
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'amply-navigation', get_theme_file_uri( '/js/navigation.js' ), array(), AMPLY_THEME_VERSION, false );
		wp_script_add_data( 'amply-navigation', 'async', true );
		wp_localize_script(
			'amply-navigation',
			'amplyScreenReaderText',
			array(
				'expand'   => __( 'Expand child menu', 'amply' ),
				'collapse' => __( 'Collapse child menu', 'amply' ),
			)
		);

		// Enqueue skip-link-focus script.
		wp_enqueue_script( 'amply-skip-link-focus-fix', get_theme_file_uri( '/js/skip-link-focus-fix.js' ), array(), AMPLY_THEME_VERSION, false );
	...
	public function enqueue_gutenberg_styles() {
		...
		// Enqueue main stylesheet.
		wp_enqueue_style( 'amply-editor-style', get_theme_file_uri( '/css/editor-styles.css' ), array(), AMPLY_THEME_VERSION );
	}
