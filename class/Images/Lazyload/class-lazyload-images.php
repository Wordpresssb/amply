...
namespace Amply\Images\Lazyload;

/**
 * Lazyload images class
 */
class Lazyload_Images {
	...
	public function enqueue_assets() {
		wp_enqueue_script( 'amply-lazy-load-images', get_theme_file_uri( 'class/Images/Lazyload/js/lazyload.js' ), array(), AMPLY_THEME_VERSION, false );
