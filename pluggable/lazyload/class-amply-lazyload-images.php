...
/**
 * Amply_Lazyload_Images class
 */
if ( ! class_exists( 'Amply_Lazyload_Images' ) ) {

	/**
	 * Amply_Lazyload_Images class
	 */
	class Amply_Lazyload_Images {
		...
		private function __construct() {
			...
			add_action( 'wp_head', array( $this, 'setup_filters' ), PHP_INT_MAX );
		...
		/**
		 * Given an array of image attributes, updates the `src`, `srcset`, and `sizes` attributes so that they load lazily.
		 *
...
Amply_Lazyload_Images::get_instance();
