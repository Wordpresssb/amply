...
/**
 * Amply_Custom_Header class
 */
if ( ! class_exists( 'Amply_Custom_Header' ) ) {

	/**
	 * Custom header class
	 */
	class Amply_Custom_Header {
		...
		public function custom_header_customize_preview_js() {
			...
			wp_enqueue_script( 'custom-header-customize-preview-js', get_theme_file_uri( 'pluggable/custom-header/js/customizer-preview.js' ), array( 'jquery', 'customize-preview' ), '20151215', true );
...
Amply_Custom_Header::get_instance();
