...
/**
 * Amply_Single_Sidebar_Component class
 */
if ( ! class_exists( 'Amply_Single_Sidebar_Component' ) ) {

	/**
	 * Amply_Single_Sidebar_Component class
	 */
	class Amply_Single_Sidebar_Component {
		...
		/**
		 * Get single sidebar type from customizer.
		 */
		public function get_sidebar_type() {

			$this->sidebar = amply_option( 'amply_single_sidebar_type' );
		...
		public function sidebar_right_view() {
			...
			if ( 'template' === amply_option( 'amply_single_sidebar_sidebar_right_type' ) ) {

				$sidebar_right_id = amply_option( 'amply_single_sidebar_sidebar_right_template' );
		...
		public function sidebar_left_view() {
			...
			if ( 'template' === amply_option( 'amply_single_sidebar_sidebar_left_type' ) ) {

				$sidebar_left_id = amply_option( 'amply_single_sidebar_sidebar_left_template' );
...
Amply_Single_Sidebar_Component::get_instance();
