...
Kirki::add_field(
	...
	array(
		'type'            => 'custom',
		'settings'        => 'amply_single_sidebar_sidebar_right_title',
...
Kirki::add_field(
	...
	array(
		'type'            => 'select',
		'settings'        => 'amply_single_sidebar_sidebar_right_type',
		...
		'default'         => amply_defaults( 'amply_single_sidebar_sidebar_right_type' ),
		'active_callback' => array(
			array(
				array(
					'setting'  => 'amply_single_sidebar_type',
...
Kirki::add_field(
	...
	array(
		'type'            => 'select',
		'settings'        => 'amply_single_sidebar_sidebar_right_template',
		...
		'default'         => amply_defaults( 'amply_single_sidebar_sidebar_right_template' ),
		'active_callback' => array(
			array(
				array(
					'setting'  => 'amply_single_sidebar_type',
			...
			array(
				'setting'  => 'amply_single_sidebar_sidebar_right_type',
				'operator' => '==',
				'value'    => 'template',
			),
		),
