...
/**
 * Filter the defaults array to add single sidebar settings default values
 *
 * @param array $defaults Defaults values.
 * @return array
 */
function amply_add_single_sidebar_defaults( $defaults ) {
...
add_filter( 'amply_default_options_filter', 'amply_add_single_sidebar_defaults' );
...
Kirki::add_field(
	...
	array(
		'type'     => 'custom',
		'settings' => 'amply_single_sidebar_type_trigger',
		'section'  => 'amply_single_sidebar_section',
		'default'  => '<div class="outer-trigger-wrap"><span>Choose the Sidebar Layout</span><button id="amply_single_sidebar_type_trigger_button" type="button" value="Choose the Sidebar Layout">Change</button></div>',
		'priority' => 10,
	)
);

/**
 * Add outer section for amply_single_sidebar_type
 * Triggered by amply_single_sidebar_type_trigger
 *
 * @param WP_Customize_Manager $wp_customize Theme Customizer object.
 */
function amply_register_single_sidebar_outer_section( $wp_customize ) {
	$wp_customize->add_section(
		'amply_single_sidebar_outer_section',
		array(
...
add_action( 'customize_register', 'amply_register_single_sidebar_outer_section' );

Kirki::add_field(
	'amply_config',
	array(
		'type'     => 'radio-image',
		'settings' => 'amply_single_sidebar_type',
		'label'    => esc_html__( 'Choose Sidebar Layout', 'amply' ),
		'section'  => 'amply_single_sidebar_outer_section',
		'default'  => amply_defaults( 'amply_single_sidebar_type' ),
		'priority' => 10,
		'choices'  => array(
