...
Kirki::add_field(
	...
	array(
		'type'            => 'custom',
		'settings'        => 'amply_default_mobilemenu_mobilemenucpt_title',
		'section'         => 'amply_default_mobilemenu_section',
		'default'         => '<h1 class="title-custom-field">MOBILE MENU CPT</h1>',
		'priority'        => 10,
...
Kirki::add_field(
	...
	array(
		'type'            => 'select',
		'settings'        => 'amply_default_mobilemenu_mobilemenucpt_template',
		'label'           => esc_html__( 'Select Template', 'amply' ),
		'description'     => esc_html__( 'Select a template in Admin > Section Templates > Mobile Menus', 'amply' ),
		'section'         => 'amply_default_mobilemenu_section',
		'priority'        => 10,
		'multiple'        => 1,
		'choices'         => Kirki_Helper::get_posts(
			[
				'posts_per_page' => -1,
				'post_type'      => 'amply_mobile_cpt',
			]
		) + [ 'none' => esc_html__( 'None', 'amply' ) ],
		'default'         => amply_defaults( 'amply_default_mobilemenu_mobilemenucpt_template' ),
		'active_callback' => array(
			array(
				'setting'  => 'amply_default_mobilemenu_type',
				'operator' => '==',
...
Kirki::add_field(
	...
	[
		'type'            => 'color',
		'settings'        => 'amply_default_mobilemenu_mobilemenucpt_bg_color',
		...
		'output'          => [
			[
				'element'  => '#default-mobilemenucpt.site-mobilemenu',
...
Kirki::add_field(
	...
	[
		'type'            => 'image',
		'settings'        => 'amply_default_mobilemenu_mobilemenucpt_bg_image',
...
Kirki::add_field(
	...
	[
		'type'            => 'select',
		'settings'        => 'amply_default_mobilemenu_mobilemenucpt_bg_image_position',
		...
		'active_callback' => [
			...
			[
				'setting'  => 'amply_default_mobilemenu_mobilemenucpt_bg_image',
				'operator' => '!=',
				'value'    => '',
			],
		],
...
Kirki::add_field(
	...
	[
		'type'            => 'select',
		'settings'        => 'amply_default_mobilemenu_mobilemenucpt_bg_image_repeat',
...
Kirki::add_field(
	...
	[
		'type'            => 'select',
		'settings'        => 'amply_default_mobilemenu_mobilemenucpt_bg_image_attachment',
...
Kirki::add_field(
	...
	[
		'type'            => 'select',
		'settings'        => 'amply_default_mobilemenu_mobilemenucpt_bg_image_size',
