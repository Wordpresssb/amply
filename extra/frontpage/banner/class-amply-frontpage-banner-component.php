<?php
/**
 * Front page Banner Component
 *
 * @package amply
 */

/**
 * Amply_Frontpage_Banner_Component class
 */
if ( ! class_exists( 'Amply_Frontpage_Banner_Component' ) ) {

	/**
	 * Amply_Frontpage_Banner_Component class
	 */
	class Amply_Frontpage_Banner_Component {
		...
		private function __construct() {
			...
			add_action( 'amply_banner', array( $this, 'frontpage_banner_view' ) );
		...
		public function get_banner_type() {
			...
			$this->banner = amply_option( 'amply_frontpage_banner_type' );
		 ...
		 * Add banner template.
		 */
		public function frontpage_banner_view() {

			if ( 'none' === $this->banner ) {
				return;
			}

			$banner_name     = 'frontpage-' . $this->banner;
			$banner_id       = amply_option( 'amply_frontpage_banner_' . $this->banner . '_template' );
			$banner_elements = amply_option( 'amply_frontpage_banner_' . $this->banner . '_elements' );
...
Amply_Frontpage_Banner_Component::get_instance();
