<?php
/**
 * Front page sidebar right options
 *
 * @package amply
 */
...
Kirki::add_field(
	...
	array(
		'type'            => 'custom',
		'settings'        => 'amply_frontpage_sidebar_sidebar_right_title',
		...
		'active_callback' => array(
			array(
				array(
					'setting'  => 'amply_frontpage_sidebar_type',
					'operator' => '==',
					'value'    => 'sidebar-right',
				),
				array(
...
Kirki::add_field(
	...
	array(
		'type'            => 'select',
		'settings'        => 'amply_frontpage_sidebar_sidebar_right_type',
		...
		'default'         => amply_defaults( 'amply_frontpage_sidebar_sidebar_right_type' ),
		'active_callback' => array(
			array(
				array(
					'setting'  => 'amply_frontpage_sidebar_type',
...
Kirki::add_field(
	...
	array(
		'type'            => 'select',
		'settings'        => 'amply_frontpage_sidebar_sidebar_right_template',
		...
		'default'         => amply_defaults( 'amply_frontpage_sidebar_sidebar_right_template' ),
		'active_callback' => array(
			array(
				array(
					'setting'  => 'amply_frontpage_sidebar_type',
			...
			array(
				'setting'  => 'amply_frontpage_sidebar_sidebar_right_type',
				'operator' => '==',
				'value'    => 'template',
			),
		),
