<?php
/**
 * Front page sidebar left options
 *
 * @package amply
 */
...
Kirki::add_field(
	...
	array(
		'type'            => 'custom',
		'settings'        => 'amply_frontpage_sidebar_sidebar_left_title',
...
Kirki::add_field(
	...
	array(
		'type'            => 'select',
		'settings'        => 'amply_frontpage_sidebar_sidebar_left_type',
		...
		'default'         => amply_defaults( 'amply_frontpage_sidebar_sidebar_left_type' ),
		'active_callback' => array(
			array(
				array(
					'setting'  => 'amply_frontpage_sidebar_type',
...
Kirki::add_field(
	...
	array(
		'type'            => 'select',
		'settings'        => 'amply_frontpage_sidebar_sidebar_left_template',
		...
		'default'         => amply_defaults( 'amply_frontpage_sidebar_sidebar_left_template' ),
		'active_callback' => array(
			array(
				array(
					'setting'  => 'amply_frontpage_sidebar_type',
			...
			array(
				'setting'  => 'amply_frontpage_sidebar_sidebar_left_type',
				'operator' => '==',
				'value'    => 'template',
			),
		),
