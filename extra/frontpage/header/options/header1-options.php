...
Kirki::add_field(
	...
	array(
		'type'            => 'custom',
		'settings'        => 'amply_frontpage_header_header1_search_toggle_title',
		'section'         => 'amply_frontpage_header_section',
...
Kirki::add_field(
	...
	array(
		'type'            => 'switch',
		'settings'        => 'amply_frontpage_header_header1_search_toggle_visibility',
		'label'           => esc_html__( 'Show on Mobile/Tablet', 'amply' ),
		'section'         => 'amply_frontpage_header_section',
		'default'         => '0',
		'priority'        => 10,
		...
		'output'          => array(
			array(
				'element'           => '#frontpage-header1 .site-search-icon',
				'property'          => 'display',
				'sanitize_callback' => 'sanitize_visibility',
			),
		),
