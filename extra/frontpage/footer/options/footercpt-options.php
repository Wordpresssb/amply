...
Kirki::add_field(
	...
	array(
		'type'            => 'custom',
		'settings'        => 'amply_frontpage_footer_footercpt_title',
...
Kirki::add_field(
	...
	array(
		'type'            => 'select',
		'settings'        => 'amply_frontpage_footer_footercpt_template',
		...
		'default'         => amply_defaults( 'amply_frontpage_footer_footercpt_template' ),
		'active_callback' => [
			[
				'setting'  => 'amply_frontpage_footer_type',
				'operator' => '==',
...
Kirki::add_field(
	...
	[
		'type'            => 'color',
		'settings'        => 'amply_frontpage_footer_footercpt_bg_color',
		...
		'output'          => [
			[
				'element'  => '#frontpage-footercpt.site-footer',
...
Kirki::add_field(
	...
	[
		'type'            => 'image',
		'settings'        => 'amply_frontpage_footer_footercpt_bg_image',
...
Kirki::add_field(
	...
	[
		'type'            => 'select',
		'settings'        => 'amply_frontpage_footer_footercpt_bg_image_position',
		...
		'active_callback' => [
			...
			[
				'setting'  => 'amply_frontpage_footer_footercpt_bg_image',
				'operator' => '!=',
				'value'    => '',
			],
		],
...
Kirki::add_field(
	...
	[
		'type'            => 'select',
		'settings'        => 'amply_frontpage_footer_footercpt_bg_image_repeat',
...
Kirki::add_field(
	...
	[
		'type'            => 'select',
		'settings'        => 'amply_frontpage_footer_footercpt_bg_image_attachment',
...
Kirki::add_field(
	...
	[
		'type'            => 'select',
		'settings'        => 'amply_frontpage_footer_footercpt_bg_image_size',
