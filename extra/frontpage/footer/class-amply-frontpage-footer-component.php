<?php
/**
 * Front page Footer Component
 *
 * @package amply
 */

/**
 * Amply_Frontpage_Footer_Component class
 */
if ( ! class_exists( 'Amply_Frontpage_Footer_Component' ) ) {

	/**
	 * Amply_Frontpage_Footer_Component class
	 */
	class Amply_Frontpage_Footer_Component {
		...
		private function __construct() {
			...
			add_action( 'amply_footer', array( $this, 'frontpage_footer_view' ) );
		...
		public function get_footer_type() {
			...
			$this->footer = amply_option( 'amply_frontpage_footer_type' );
		 ...
		 * Add footer template.
		 */
		public function frontpage_footer_view() {
...
Amply_Frontpage_Footer_Component::get_instance();
