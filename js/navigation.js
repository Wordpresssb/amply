...
function toggleSubMenu( parentMenuItem, forceToggle ) {
	...
	if ( parentMenuItemToggled ) {
		...
		toggleButton.setAttribute( 'aria-label', amplyScreenReaderText.expand );
		...
		toggleButton.setAttribute( 'aria-label', amplyScreenReaderText.collapse );
...
function getDropdownButton() {
	...
	dropdownButton.setAttribute( 'aria-label', amplyScreenReaderText.expand );
